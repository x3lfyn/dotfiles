...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    loaded = true,
    path = "/home/kadyklesha/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["hyprland-vim-syntax"] = {
    loaded = true,
    path = "/home/kadyklesha/.local/share/nvim/site/pack/packer/start/hyprland-vim-syntax",
  ...
  ["symbols-outline.nvim"] = {
    ...
    loaded = true,
    path = "/home/kadyklesha/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
